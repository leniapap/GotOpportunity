...
public class RegistryFrame extends JFrame {
	...
	public RegistryFrame() {
		...
		lblSelectType.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		btnCandidate.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		btnCompany.setFont(new Font("Times New Roman", Font.BOLD, 20));
